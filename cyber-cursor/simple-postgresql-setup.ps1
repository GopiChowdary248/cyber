...
Write-Host "PostgreSQL is ready for CyberShield!" -ForegroundColor Green
...
Write-Host "Start your CyberShield backend:" -ForegroundColor Cyan
Write-Host "   cd backend" -ForegroundColor White
Write-Host "   python main.py" -ForegroundColor White

Write-Host "For more details, see: POSTGRESQL_SETUP_GUIDE.md" -ForegroundColor Cyan
